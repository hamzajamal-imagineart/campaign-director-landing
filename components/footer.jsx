  ...
  return (
    <>
      ...
      <footer className="sf">
          ...
          <div className="sf-top">
            ...
            <div className="sf-brand">
              ...
              <div className="sf-app">
                <span className="sf-app-lbl">Try Imagine Mobile</span>
                <a href="https://app.adjust.com/1a1xymg6" className="sf-store" target="_blank" rel="noopener noreferrer">
                  <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
                  App Store
                </a>
                <a href="https://app.adjust.com/1rx90a0u" className="sf-store" target="_blank" rel="noopener noreferrer">
            ...
            <div className="sf-cols">
              ...
              <div className="sf-col">
                <span className="sf-col-h">Explore</span>
                <ul>
              ...
              <div className="sf-col">
                <span className="sf-col-h">Tools</span>
                <ul>
              ...
              <div className="sf-col">
                <span className="sf-col-h">Contact Us</span>
                <ul>
              ...
              <div className="sf-col">
                <span className="sf-col-h">Community</span>
                <ul>
              ...
              <div className="sf-col">
                <span className="sf-col-h">Trust and Reviews</span>
                <div className="sf-trust">
                  <a href="https://trust.imagine.art" target="_blank" rel="noopener noreferrer" className="sf-soc2">
                  ...
                  <a href="https://www.trustpilot.com/review/www.imagine.art" target="_blank" rel="noopener noreferrer" className="sf-tp">
                    <span className="sf-tp-name">
        ...
        <div className="sf-inner-bar">
          <div className="sf-bar">
            <div className="sf-bar-l">
              <span className="sf-copy">© {year} <strong style={{ fontWeight: 600 }}>Vyro Turkey</strong>. All rights reserved.</span>
              <button className="sf-cookies" type="button">Manage Cookie Preferences</button>
            </div>
            <div className="sf-socials">
              <a href="https://www.facebook.com/groups/imagineai" className="sf-soc" target="_blank" rel="noopener noreferrer" title="Facebook">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://x.com/ImagineArt_X" className="sf-soc" target="_blank" rel="noopener noreferrer" title="Twitter / X">
              ...
              <a href="https://discord.com/invite/z7kjUyvAbv" className="sf-soc" target="_blank" rel="noopener noreferrer" title="Discord">
              ...
              <a href="https://www.instagram.com/imagineartofficial" className="sf-soc" target="_blank" rel="noopener noreferrer" title="Instagram">
              ...
              <a href="https://www.youtube.com/@imagineartofficial" className="sf-soc" target="_blank" rel="noopener noreferrer" title="YouTube">
              ...
              <a href="https://www.reddit.com/r/ImagineAiArt/" className="sf-soc" target="_blank" rel="noopener noreferrer" title="Reddit">
